...
async def optimize_strategy(strategy_name, symbol, param_ranges, start_date, end_date, config, logger, market_type="spot"):
    """
    ...
    for i, combo in enumerate(combinations):
        ...
        # Add required keys to test_config if they don't exist
        if "enabled_spot" not in test_config:
            test_config["enabled_spot"] = True
        if "enabled_futures" not in test_config:
            test_config["enabled_futures"] = True
...
if __name__ == "__main__":
    ...
    parser.add_argument("--market", default="spot", help="Market type (spot or futures)")
