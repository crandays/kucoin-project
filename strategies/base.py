...
class Strategy(ABC):
    def __init__(self, config: dict, name: str):
        ...
        # Check if config has direct enabled flags or get from strategy config with defaults
        self.enabled_spot = config.get("enabled_spot", strategy_config.get("enabled_spot", True))
        self.enabled_futures = config.get("enabled_futures", strategy_config.get("enabled_futures", True))
